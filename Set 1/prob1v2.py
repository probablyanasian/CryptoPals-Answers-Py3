def hextobytes(inputa):
    return(bytes.fromhex(str(inputa))) #.decode('ascii',errors='ignore')

def hextobin(inputa):
    return(bin(int(inputa, base=16)))
...
print(bintob64(hextobin('49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d')))